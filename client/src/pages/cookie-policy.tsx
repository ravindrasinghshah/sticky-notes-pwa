    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 to-accent/10">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p>
                ...
                access to secure areas, and authentication. The Service cannot
                function properly without these cookies.
              </p>
              <div className="bg-muted p-3 rounded mt-2">
                <p>
                  <strong>Examples:</strong> Authentication tokens, session
                  management, security cookies
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                This helps us improve our Service's performance and user
                experience.
              </p>
              <div className="bg-muted p-3 rounded mt-2">
                <p>
            ...
            <div>
              ...
              <div className="bg-muted p-3 rounded mt-2">
                <p>
                  <strong>Examples:</strong> Advertising networks, social media
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            <p>
              Some cookies on our Service are set by third-party services that
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            <p>
              ...
              and parts of our Service may not function properly.
            </p>
            ...
            <div>
              ...
              <div className="bg-muted p-3 rounded mt-2">
                <p>
                  <strong>Popular browsers:</strong>
                </p>
            ...
            <div>
              ...
              <p>
                When you first visit our Service, you may see a cookie consent
                banner. You can choose which types of cookies to accept or
                reject. You can also change your preferences at any time through
                our settings.
              </p>
            </div>
          </CardContent>
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                <strong>Authentication cookies:</strong> Typically expire after
